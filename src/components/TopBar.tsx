...
const ThreadsIcon = () => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M12 2C6.477 2 2 6.477 2 12c0 5.522 4.477 10 10 10 5.524 0 10-4.478 10-10 0-5.523-4.476-10-10-10Zm4.29 13.118c-.644 1.035-1.84 1.624-3.352 1.624-1.995 0-3.637-1.255-3.906-2.965l1.702-.26c.183.852.933 1.517 2.204 1.517.688 0 1.204-.204 1.454-.612.228-.364.272-.888.117-1.296-.21-.548-.75-.822-1.635-.986l-.97-.183c-1.404-.264-2.386-1.062-2.674-2.2-.286-1.135.088-2.294.96-3.018.732-.61 1.742-.904 2.823-.832 1.647.113 3.004 1.075 3.332 2.38l-1.64.433c-.177-.632-.82-1.057-1.648-1.115-.552-.038-.988.094-1.264.323-.263.218-.372.53-.291.85.105.418.516.676 1.236.81l.986.187c1.472.28 2.478 1.015 2.869 2.1.39 1.083.2 2.21-.389 3.03Z" />
  </svg>
);
