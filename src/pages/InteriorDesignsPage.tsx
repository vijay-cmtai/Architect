  ...
  <>
    ...
    >
      ...
      <div className="space-y-4 sm:space-y-6">
        <div>
          <Label htmlFor="theme" className="font-semibold text-gray-600 text-sm sm:text-base">
            Theme
          </Label>
          <Select
            value={filters.theme}
        ...
        <div>
          <Label htmlFor="roomType" className="font-semibold text-gray-600 text-sm sm:text-base">
            Room Type
          </Label>
          <Select
        ...
        <div>
          <Label htmlFor="propertyType" className="font-semibold text-gray-600 text-sm sm:text-base">
            Property Type
          </Label>
          <Select
          ...
          <div className="w-full lg:w-3/4 xl:w-4/5">
            ...
            {!isLoading && !isError && (
              <>
                ...
                {/* Pagination */}
                {totalPages > 1 && (
                  <div className="mt-8 sm:mt-12 flex flex-col sm:flex-row justify-center items-center gap-3 sm:gap-4 px-4">
                    <Button
                      variant="outline"
                    ...
                    <span className="font-medium text-sm sm:text-base order-first sm:order-none">
