...
const ConstructionProductsPage: React.FC = () => {
  ...
  return (
    <div className="bg-gray-50">
      {/* --- Helmet Tag for SEO --- */}
      <Helmet>
        <title>Home Design Product Store | Modern Plans & Interior Ideas</title>
        <meta
          name="description"
          content="Shop modern home design products, contemporary plans, and creative interior ideas. Elevate your space with curated decor, furniture, and inspiration for every room."
        />
      </Helmet>
