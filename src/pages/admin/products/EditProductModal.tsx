    ...
    if (product) {
      ...
      setSelectedCountries(
        typeof product.country === "string"
          ? product.country.split(",").filter(Boolean)
          : product.country || []
      );
      setIsSale(product.isSale || false);
      setCrossSell(
        typeof product.crossSellProducts === "string"
          ? product.crossSellProducts.split(",").filter(Boolean)
          : product.crossSellProducts || []
      );
      setUpSell(
        typeof product.upSellProducts === "string"
          ? product.upSellProducts.split(",").filter(Boolean)
